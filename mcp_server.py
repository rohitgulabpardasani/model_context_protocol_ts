#!/usr/bin/env python3
"""
Cisco CPU-Only MCP (Training Version with Placeholder)

Usage:
  python server_cpu_placeholder.py --inventory devices.yaml
"""
...
mcp = FastMCP("Cisco CPU-Only MCP (Placeholder Version)")
...
# 🚨🚨🚨 STUDENT TODO: Replace the regex below with a correct one 🚨🚨🚨
CPU_RE = re.compile(r"^___FIX_ME_PLEASE___$", re.IGNORECASE)
